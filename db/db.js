...
/* Selects all from the inspection table in reverse chronological order and has limit on 10 */
class Inspection {
  static all(callback) {
    pool.getConnection((err, connection) => {
      if (err) throw err
  ...
  /* Selects all from the inspections table in reverse chronological order and has limit on 1 */
  ...
  /* Selects all from the inspections table in reverse chronological order and has limit on 5 */
